    ...
    return (
        <header className="sticky top-0 z-10 w-full bg-white border-b border-gray-200">
            <div className="flex items-center justify-between h-16 max-w-screen-2xl mx-auto px-6 relative">
                ...
                {/* 온보딩일 경우 로그인 버튼만 */}
                {isOnboarding ? (
                    <Link to="/account/login" className="w-20 py-1 text-sm font-semibold text-white text-center rounded-full bg-orange-400 hover:bg-orange-500 whitespace-nowrap">
                        Login
                    </Link>
                ) : (
                    <>
                        ...
                        <div className="hidden min-[1200px]:flex items-center space-x-8 text-sm text-[#242424] font-medium">
                            ...
                            <Link to="/kbti" className="px-3 py-1 rounded-md hover:bg-gray-100 whitespace-nowrap">KBTI</Link>
                            <Link to="/mypage" className="px-3 py-1 rounded-md hover:bg-gray-100 whitespace-nowrap">마이페이지</Link>
                            <Link to="/account/login" className="w-20 py-1 text-sm font-semibold text-white text-center rounded-full bg-orange-400 hover:bg-orange-500 whitespace-nowrap">
                                Login
                            </Link>
                        </div>
