...
const bannerSlides = [
    ...
    },
    {
        ...
        subText: '원하는 스타일로 키보드를 커스텀하고, 실제 책상 위에 배치해보세요.',
        route: '/customkeyboard',
    },
    {
        text: '당신의 키보드 성향은? KBTI로 확인해보세요!',
        subText: '간단한 테스트로 내 취향을 분석하고 딱 맞는 키보드를 추천받아보세요!',
        route: '/kbti',
    },
]
    ...
    return (
        <div className="flex flex-col items-center w-full">
            ...
            <Swiper
                ...
                spaceBetween={30}
                slidesPerView={1}
                className="w-full h-[400px] mb-12 rounded-md overflow-hidden bg-white"
            >
                    ...
                    <SwiperSlide key={idx}>
                        ...
                        >
                            <div className="flex-1">
                                <h2 className="text-2xl font-bold text-tadak-black mb-3">{slide.text}</h2>
                                <p className="text-gray-500 text-base mb-40">{slide.subText}</p>
                            </div>
                            <div className="flex-1 flex justify-center items-center">
                                {/* 이미지 넣을 경우 여기에 삽입 */}
                                <div className="w-60 h-40 bg-gray-100 rounded-md flex items-center justify-center text-gray-400">
                                    이미지 자리
                                </div>
                            </div>
                        </div>
